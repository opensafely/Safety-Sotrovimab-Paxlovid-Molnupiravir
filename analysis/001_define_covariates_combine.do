...
tab drug //7=116, 8=38
replace drug=1 if sotrovimab==date_treated & sotrovimab_start==1 
...
tab _st  // keep if _st==1 -> removes observations that end on or before enter -> should be 0 in actual dataset
tab _t,m
tab _t drug,m col

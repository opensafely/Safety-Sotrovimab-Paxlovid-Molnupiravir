...
drugs_interaction_paxlovid_codes = codelist_from_csv(
  "codelists/opensafely-sps-paxlovid-interactions-do-not-use-dmd.csv",  system = "Pseudo BNF", column = "dmd_id"
)
drugs_interaction_nirmatrelvir_codes = codelist_from_csv(
  "codelists/opensafely-nirmatrelvir-drug-interactions-dmd.csv",  system = "Pseudo BNF", column = "dmd_id"
)
